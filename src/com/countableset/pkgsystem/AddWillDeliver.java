...
public class AddWillDeliver extends Activity
{
	// Variables
	...
	// Server Stuff
	private static final String URL_ADD = "http://dev.countableset.com/android/add_will.php";
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		actionBar.setTitle(R.string.title_bar_willdeliver);
			...
			ContextMenuInfo menuInfo)
	{
		...
		menu.add(0, FRIEND_ID, 0, R.string.WillDeliver_menu);
	}
	...
	public boolean onContextItemSelected(MenuItem item)
	{
		switch (item.getItemId())
		{
			case FRIEND_ID:
				...
				Toast.makeText(AddWillDeliver.this, friendContext.toString() + " Added", Toast.LENGTH_SHORT).show();
    	        finish();
				return true;
		}
